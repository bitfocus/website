...
There is limited support for T-bars and shuttle/jog wheels; their values are exposed via custom variables that can be associated with the device in the _Surface_ settings.
