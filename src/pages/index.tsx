	...
	return (
		<section className={landingStyles.heroSection}>
			<div style={{ textAlign: 'center', marginBottom: '2rem' }}>
				<img alt="Companion Icon" width="128" height="128" src="img/companion-logo.png" />
			</div>
			<Heading as="h1" className={landingStyles.heroTitle}>
				<span>Companion</span>
			</Heading>
			<p className={landingStyles.heroSubtitle} style={{ fontWeight: 600, fontSize: '1.25rem', marginBottom: '2rem' }}>
			...
			>
				Companion elevates the affordable Elgato Stream Deck and similar devices into professional control surfaces for
				an extensive range of equipment and applications. From presentation switchers and broadcast equipment to video
				playback software and home automation systems, Companion delivers studio-grade control, putting powerful
				...
				<div className={landingStyles.featuresVideoContainer}>
					<div className={landingStyles.featuresContent}>
						<p style={{ fontSize: '1rem', marginBottom: '1rem' }}>
							You don't need an actual stream deck to use it. Companion both comes with a builtin stream deck emulator,
							a webpage for touch screens and the ability to trigger buttons via OSC, TCP, UDP, HTTP, WebSocket and
							ArtNet. It does the same job, just without the buttons.
						</p>
						<ul
							style={{
								listStyleType: 'disc',
