...
description: 'Overview of API 2.1 changes (abort signals, action results, graphics overhaul, affectedProperties, internal actions and feedback-driven local variables in presets).'
---
