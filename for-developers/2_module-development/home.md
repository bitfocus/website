...
Before you start, make sure you have [Installed the Development Tools](../0_intro/setting-up-developer-environment.md) and familiarized yourself with [Git Workflows](../1_git-workflows/).
